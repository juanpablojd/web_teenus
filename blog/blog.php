...
<body>
                ...
                <div class="container">
                    ...
                    <div class="right-button">
                        <ul>
                            ...
                            <li><a class="sign_up" href="http://tezliksoftware.com.co/register">Registrate gratis</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <section class="hero-banner d-flex align-items-center">
        <div class="container text-center tituloBlog">
            <!-- <h2 id="titulo"></h2> -->
            ...
            <div class="row">
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img imgNoticia">
                            <!-- <img class="img-fluid imgNoticia" src="img/main-blog/m-blog-1.jpg" alt=""> -->
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget recentpost">
