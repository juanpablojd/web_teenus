...
<head>
    ...
    <link rel="stylesheet" href="../service/css/themify-icons.css">
    <link rel="stylesheet" href="../service/vendors/fontawesome/css/all.min.css">
    <link rel="stylesheet" href="../service/vendors/owl-carousel/owl.carousel.min.css">
    <link rel="stylesheet" href="../service/vendors/animate-css/animate.css">
    <!-- main css -->
...
<body>
                ...
                <div class="container">
                    ...
                    <div class="right-button">
                        <ul>
                            ...
                            <li><a class="sign_up" href="http://tezliksoftware.com.co/register">Registrate gratis todo un mes</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="img/main-blog/m-blog-1.jpg" alt="">
                        </div>
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="img/prev.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="arrow">
                                        <a href="#">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="img/next.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="img/popular-post/post1.jpg" alt="post">
                                <div class="media-body">
                            ...
                            <div class="media post_item">
                                <img src="img/popular-post/post2.jpg" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                            ...
                            <div class="media post_item">
                                <img src="img/popular-post/post3.jpg" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                            ...
                            <div class="media post_item">
                                <img src="img/popular-post/post4.jpg" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
    ...
    <script src="../service/js/jquery-2.2.4.min.js"></script>
    <script src="../service/js/popper.js"></script>
    <script src="../service/js/bootstrap.min.js"></script>
    <script src="../service/vendors/owl-carousel/owl.carousel.min.js"></script>
    <script src="../service/js/jquery.ajaxchimp.min.js"></script>
    <script src="../service/js/waypoints.min.js"></script>
    <script src="../service/js/mail-script.js"></script>
    <script src="../service/js/contact.js"></script>
    <script src="../service/js/jquery.form.js"></script>
    <script src="../service/js/jquery.validate.min.js"></script>
    <script src="../service/js/mail-script.js"></script>
